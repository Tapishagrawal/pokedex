...
export default function UserSinglePokemon() {
    ...
    return (
        <>  {
            ...
            <div className={`${isPokemonVisible ? "w-[38%]" : "w-0 opacity-0 hidden"} transition-all duration-500`}>
                <div className='bg-white p-7 rounded-2xl w-[520px] h-[800px]'>
                    <div className=' flex flex-col items-center'>
                        ...
                        <div className='w-[50%] relative'>
                            <img src={pokemonDetail.sprites.front_default} alt="" className='w-[400px] z-10 relative -mr-10' />
                            <div style={{ backgroundColor: typeColor[pokemonDetail.types[0].type.name] }} className={`absolute top-[60%] left-[50%] -translate-x-[50%] -translate-y-[40%] w-[270px] h-[270px] rounded-full blur-3xl opacity-60`}></div>
                        </div>
                        <div className='w-[50%] self-start mt-10'>
